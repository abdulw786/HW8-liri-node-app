...
if(command == "concert-this"){
    let bisURL = "https://rest.bandsintown.com/artists/" + input + "/events?app_id=codingbootcamp";
    ...
    if(input === undefined){
        ...
        let omdbURL = "http://www.omdbapi.com/?t=" + input + "&y=&plot=short&apikey=trilogy";
    ...
    fs.readFile("random.txt", "utf8", function(error, data){
        ...
        if(dataArr[0] == "concert-this"){
            let bisURL = "https://rest.bandsintown.com/artists/" + dataArr[1] + "/events?app_id=codingbootcamp";
            request(bisURL, function(error, response, body){
                if (!error && response.statusCode === 200) {
                    let output = JSON.parse(body);
                    for(i=0; i<output.length; i++){
            ...
            if(dataArr[0] === undefined){
                ...
                let omdbURL = "http://www.omdbapi.com/?t=" + dataArr[1] + "&y=&plot=short&apikey=trilogy";
                request(omdbURL, function(error, response, body){
